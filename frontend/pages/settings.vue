            ...
            <v-sheet>
                <v-container>
                    <v-form>
                        ...
                        <v-textarea v-model="selectedPet.description" 
                            label="Beschreibung" variant="outlined" rows="3"/>
            ...
            <v-sheet>
                <v-container>
                    <v-form>
                        ...
                        <v-text-field v-model="selectedFood.num_packets" label="Anzahl Packungen" variant="outlined" type="number"/>
                        <v-text-field v-model="selectedFood.packet_size" label="Packungen Größe" variant="outlined" type="number"/>
                        <v-select v-model="selectedFood.unit" :items=foodOptions.data.value.units item-title="name" item-value="value" label="Einheit" variant="outlined"/>
                        <v-select v-model="selectedFood.category" :items=foodOptions.data.value.categories item-title="name" item-value="value" label="Kategorie" variant="outlined"/>
